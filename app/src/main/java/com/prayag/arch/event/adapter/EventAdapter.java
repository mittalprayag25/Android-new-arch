package com.prayag.arch.event.adapter;
...
public class EventAdapter extends RecyclerView.Adapter<EventViewHolder> {
    ...
    public EventAdapter(List<Event> items, Context context, View.OnClickListener viewClickListener, View.OnClickListener deleteClickListener) {
        this.items = items;
